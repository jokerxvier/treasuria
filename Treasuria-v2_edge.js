...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            text:"60",
            align:"left",
            font:['\'Lucida Console\', Monaco, monospace',[131.25,"%"],"rgba(255,255,255,1)","bold","none","normal"],
         ...
         },
         {
            ...
            text:"500",
            align:"center",
            font:['Lucida Console, Monaco, monospace',[137.5,"%"],"rgba(0,0,0,1)","700","none","normal"],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid224", tween: [ "style", "${_treasure_box_2}", "right", '18.65%', { fromValue: '18.65%'}], position: 1000, duration: 0 },
            ...
            { id: "eid141", tween: [ "style", "${_treasure_box_2}", "top", '4.17%', { fromValue: '4.17%'}], position: 1000, duration: 0 },
