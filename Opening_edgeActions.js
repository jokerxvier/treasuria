...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){var mySound=new buzz.sound("assets/sounds/treasuria_intro",{formats:["ogg","mp3","aac"]});mySound.play().fadeIn().unloop().bind("timeupdate",function(){var timer=buzz.toTimer(this.getTime());document.getElementById("timer").innerHTML=timer;});});
//Edge binding end
})("stage");
